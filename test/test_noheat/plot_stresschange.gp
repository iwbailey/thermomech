...
set output 'test_noheat_stresschange.png'
...
plot 'test_noheat_initstress.txt' using 1:2:3 with image

set origin 0.0,0.3;
set cblabel "Final Stress [MPa]"
plot 'test_noheat_finalstress.txt' using 1:2:3 with image

set origin 0.0,0.0;
set cblabel "Stress Increase [MPa]"
plot '< paste test_noheat_initstress.txt test_noheat_finalstress.txt' \
