...
set output 'test_circlerupt_slippartition.png'
...
plot 'test_circlerupt_creepslip.txt' using 1:2:3 with image

set origin 0.0,0.33;
set cblabel "Slip From Earthquake [m]"
plot 'test_circlerupt_eqkslip.txt' using 1:2:3 with image

set origin 0.0,0.0;
set cblabel "Remaining Slip Deficit [m]"
plot 'test_circlerupt_finalslipdef.txt' using 1:2:3 with image
